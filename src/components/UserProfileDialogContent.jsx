            ...
            <div className="relative px-6 pb-6 pt-16">
                ...
                <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {user.status && (
                                <>
                                    ...
                                    <p className="text-sm text-gray-500 italic">"{user.status}"</p>
                                </>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="grid gap-6">
                        <section>
                            <h3 className="mb-3 text-[11px] font-bold uppercase tracking-wider text-gray-400">About Me</h3>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <section>
                                <h3 className="mb-3 text-[11px] font-bold uppercase tracking-wider text-gray-400">Member Since</h3>
                            ...
                            {user.pronouns && (
                                <section>
                                    <h3 className="mb-3 text-[11px] font-bold uppercase tracking-wider text-gray-400">Pronouns</h3>
