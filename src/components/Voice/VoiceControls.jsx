import { Microphone, MicrophoneSlash, SpeakerHigh, SpeakerSlash, PhoneDisconnect, WifiHigh, VideoCamera, VideoCameraSlash, Monitor } from '@phosphor-icons/react';
import { useVoiceStore } from '@/store/voice.store';
import { VoiceService } from '@/services/voice.service';

const VoiceControls = () => {
    const { channelName, connectionState, isMuted, isDeafened, isCameraOn, isScreenSharing } = useVoiceStore();
    ...
    return (
        <div className="border-t border-white/5 bg-gray-800 px-2 py-3">
            ...
            <div className="flex items-center justify-center gap-1">
                ...
                >
                    {isCameraOn ? <VideoCamera className="size-5" /> : <VideoCameraSlash className="size-5" />}
                </button>
